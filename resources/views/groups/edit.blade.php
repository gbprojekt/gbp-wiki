    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-8 offset-col-2">
                <h3 class="text-left col">Gruppe ändern</h3>
                    ...
                    <div class="form-group my-4">
                        ...
                        @foreach($permissions as $permission)
                            <div class="form-check form-check-inline form-switch">
                                <input class="form-check-input" type="checkbox" id="{{ $permission->id }}" name="permissions[]" value="{{ $permission->id }}" @if($group->hasPermission($permission->id)) checked @endif>
